...
public class payslipupload extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payslipupload);
...
//UPLOADING THE IMAGE
    ...
    private void uploadimage(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_PAYSLIPUPLOAD,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
                        // Intent myIntent = new Intent(payslipupload.this,lastactivity.class);
                        //               startActivity(myIntent);

                        AlertDialog.Builder builde = new AlertDialog.Builder(payslipupload.this);
                        builde.setMessage("Thank you for your loan application with MHSACCO LOANS.You will be notified shortly for your loan approval")
                                ...
                                .setPositiveButton("MAIN MENU", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        startActivity(new Intent(payslipupload.this, variousitems.class));
                                        finish();
                                ...
                                .setNegativeButton("LOG OUT", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        startActivity(new Intent(payslipupload.this, LoginActivity.class));
                                        finish();
                        ...
                        try {
                            ...
                            Toast.makeText(payslipupload.this,Response,Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(payslipupload.this, "check connection", Toast.LENGTH_SHORT).show();
                //Toast.makeText(
        ...
        RequestHandler.getInstance(payslipupload.this).addToRequestQueue(stringRequest);
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Are you sure you want to exit")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent myintent = new Intent(payslipupload.this, variousitems.class);
                        startActivity(myintent);
                        finish();
