...
public class finishapply extends AppCompatActivity implements View.OnClickListener {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            AlertDialog.Builder builde = new AlertDialog.Builder(finishapply.this);
                            builde.setMessage("Thank you for your loan application with MHSACCO LOANS.You will be notified shortly for your loan approval")
                                    ...
                                    .setPositiveButton("MAIN MENU", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            startActivity(new Intent(finishapply.this,variousitems.class));
                                            finish();
                                    ...
                                    .setNegativeButton("LOG OUT", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            startActivity(new Intent(finishapply.this,LoginActivity.class));
                                            finish();
                            ...
                            //    Intent myIntent = new Intent(finishapply.this, finishapply.class);
                          //  startActivity(myIntent);
                            ...
                            try {
                              ...
                              //  Intent myInten = new Intent(finishapply.this, finishapply.class);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.hide();
                            Toast.makeText(finishapply.this, "check your internet connection", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Are you sure you want to exit")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent myintent =new Intent(finishapply.this,variousitems.class);
                        startActivity(myintent);
                        finish();
